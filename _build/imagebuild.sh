...
for target in ${build_targets}; do
    ...
    # keeps us from descending into the assembled src/ tree, where upstream
    # repos (e.g. ansible-collections-openstack/changelogs/config.yaml) ship
    # their own config.yaml and would otherwise be misread as a "src" project.
